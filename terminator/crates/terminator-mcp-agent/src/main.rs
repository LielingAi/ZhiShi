...
async fn main() -> Result<()> {
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        let _ = std::process::Command::new("cmd")
            ...
            // PATCH(zhishi): detach stdio — without this the chcp child inherits
            // our stdout and prints "Active code page: 65001" into the JSON-RPC
            // stream, corrupting MCP framing for the host client.
