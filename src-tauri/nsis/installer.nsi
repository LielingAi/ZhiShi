...
Function PageReinstall
  ...
  ; ZhiShi: Save old version string before comparison overwrites $R0
  ...
  ; Upgrading - ZhiShi: swapped options so "overwrite upgrade" is default
...
Function PageLeaveReinstall
  ...
  ${ElseIf} $R0 = 1 ; Upgrading - ZhiShi: inverted logic due to swapped options
...
; ZhiShi: Git for Windows installation section
  ...
  ${If} $4 == ""
    ...
    git_not_found:
      ...
      ${If} $UpdateMode <> 1
        ...
        ; To update Git version: replace nsis/Git-Installer.exe and update .\scripts\setup\setup_windows.ps1
