; Simplified Chinese language file for ZhiShi NSIS Installer
...
LangString alreadyInstalledLong ${LANG_SIMPCHINESE} "检测到您已安装了 ZhiShi $R5 版本。$\n$\n您可以选择重新安装或卸载。"
...
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "检测到您已安装了 ZhiShi $R5 版本，当前正在安装 ZhiShi ${VERSION} 版本。$\n$\n您可以直接下一步进行安装。"
