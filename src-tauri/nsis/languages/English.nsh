; English language file for ZhiShi NSIS Installer
...
LangString alreadyInstalledLong ${LANG_ENGLISH} "ZhiShi $R5 is already installed.$\n$\nYou can choose to reinstall or uninstall."
...
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "ZhiShi $R5 is already installed. You are about to install ZhiShi ${VERSION}.$\n$\nYou can proceed with the upgrade directly."
