...
**v1.5.3 · 安全研究领域的 agent harness：环境融合、原生工具、原生代码、研究档案。**
...
| 项 | 状态 |
|---|---|
| 单元测试 | 2400+ 全绿；`tsc --noEmit` / `eslint` 零错 / depcruise 架构边界强制 |
...
| 文档 | 内容 |
|---|---|
| `docs/roadmap.md` | 版本任务池（当前线：**1.5.x**——1.5.3 治本（流/状态/指针三层分离 + 压缩中枢改造）已发版） |
