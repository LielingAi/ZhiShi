...
**v1.5.1 · 安全研究领域的 agent harness：环境融合、原生工具、原生代码、研究档案。**
...
| 项 | 状态 |
|---|---|
| 单元测试 | 2380+ 全绿；`tsc --noEmit` / `eslint` 零错 / depcruise 架构边界强制 |
...
| 文档 | 内容 |
|---|---|
| `docs/roadmap.md` | 版本任务池（当前线：**1.5.x**——1.5.1 注入面瘦身（专家知识 harness 邻域注入）已发版） |
