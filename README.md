...
**v1.4.10 · 安全研究领域的 agent harness：环境融合、原生工具、原生代码、研究档案。**
...
| 项 | 状态 |
|---|---|
| 单元测试 | 2410+ 全绿；`tsc --noEmit` / `eslint` 零错 / depcruise 架构边界强制 |
...
| 文档 | 内容 |
|---|---|
| `docs/roadmap.md` | 版本任务池（当前线：1.4.x——1.4.10 第三方 API（中转站）支持已发版） |
